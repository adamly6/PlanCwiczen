...
import kotlinx.android.synthetic.main.poniedzialek_add.all_cwiczenia


class PoniedzialekAddActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.poniedzialek_add)
        ...
        override fun bind(viewHolder: GroupieViewHolder, position: Int) {
            ...
            viewHolder.itemView.cwiczenie_add.setOnClickListener {
                ...
                Toast.makeText(applicationContext, "Dodano ćwiczenie: ${nazwa_cwiczenie.nazwa}", Toast.LENGTH_SHORT).show()
                   ...
                   val ref1 = FirebaseDatabase.getInstance().getReference("/users/$uid/cwiczenia/poniedzialek")
                var licznik = 1
                   ref1.addListenerForSingleValueEvent(object: ValueEventListener  {
                      ...
                      override fun onDataChange(snapshot: DataSnapshot) {
                         ...
                         snapshot.children.forEach {
                          ...
                          val ref = FirebaseDatabase.getInstance().getReference("/users/$uid/cwiczenia/poniedzialek/${nazwa_cwiczenie.id}")
...
class CwiczenieAdd(val id: Int, val nazwa: String ) {
    constructor() : this(-1, "")
}